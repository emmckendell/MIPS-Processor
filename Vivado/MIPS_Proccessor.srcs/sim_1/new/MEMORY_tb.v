...
module MEMORY_tb;
    ...
    reg EX_MEM_controlMEM_Branch;
    reg EX_MEM_controlMEM_MemRead;
    reg EX_MEM_controlMEM_MemWrite;
    
    reg [1:0] EX_MEM_controlWB;
    reg EX_MEM_zeroFlag;
    ...
    reg [31:0] EX_MEM_npc;
    reg [31:0] EX_MEM_addressMemory;
    reg [31:0] EX_MEM_writeDataMemory;
