...
module control(
    ...
    always @(opcode) begin
        case (opcode)
            6'b000000: begin // r-format instruction (e.g., add, sub) (0)
            ...
            6'b100011: begin // lw (load word) (35)
            ...
            6'b101011: begin // sw (store word) (43)
            ...
            6'b000100: begin // beq (branch if equal) (4)
