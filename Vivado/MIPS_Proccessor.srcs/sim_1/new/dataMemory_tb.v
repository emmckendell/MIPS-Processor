...
module dataMemory_tb;
    ...
    begin
        ...
        // write to memory1
        addressMemory = 32'd1;
        writeDataMemory = 32'hA5A5_A5A5;
        MemWrite = 1;
        MemRead = 0;
        #10;
        // Expected readData_mem = 0000_0000
        ...
        MemRead = 1;
        #10;
        // Expected readData_mem = A5A5_A5A5
        ...
        // write to and read from memory3
        addressMemory = 32'd3;
        writeDataMemory = 32'hFFFF_FFFF;
        MemWrite = 1;
        MemRead = 1;
        #10;
        // Expected readData_mem = FFFF_FFFF
        
        // write to memory3
        addressMemory = 32'd3;
        writeDataMemory = 32'hC3C3_C3C3;
        MemWrite = 1;
        MemRead = 0;
        #10;
        // Expected readData_mem = 0000_0000
        ...
        // read from memory3
        addressMemory = 32'd3;
        writeDataMemory = 32'h0000_0000;
        MemWrite = 0;
        MemRead = 1;
        #10;
        // Expected readData_mem = C3C3_C3C3
